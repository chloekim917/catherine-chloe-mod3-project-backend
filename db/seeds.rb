...
Expenditure.create(date: 07012020, category_id: food.id, detail:"bubble tea", amount: 5.0)
Expenditure.create(date: 07012020, category_id: utility.id, detail:"PSEG bill", amount: 50.0)
Expenditure.create(date: 07012020, category_id:entertainment.id, detail:"Ballet tickets", amount: 500.0)
Expenditure.create(date: 07012020, category_id:housing.id, detail:"Monthly rent", amount: 1400.0)
Expenditure.create(date: 07012020, category_id:entertainment.id, detail:"Tribeca Film Festival tix", amount: 25.0)
Expenditure.create(date: 07012020, category_id: food.id, detail:"In 'n Out", amount: 15.0)
Expenditure.create(date: 07012020, category_id:utility.id, detail:"Electricity bill", amount: 65.0)
